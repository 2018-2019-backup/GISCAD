...
class _declspec(dllexport) CNSCompositeData//_declspec(dllexport) 
{
public:
	CNSCompositeData(void){/*m_strPoslist = NULL*/;};
public:
	//virtual ~CNSCompositeData(void){/*delete []m_strPoslist*/;};
	~CNSCompositeData(void){/*delete []m_strPoslist*/;};
...
class _declspec(dllexport) CNSCompositeGeometry //_declspec(dllexport)
{
public:
...
class _declspec(dllexport) CNSCompositeContainer//_declspec(dllexport) 
{
public:
