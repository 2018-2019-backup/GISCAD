...
void CNSHyperEdit::SetDefaultCursor()
{
...
LONG CNSHyperEdit::GetRegKey(HKEY key, LPCTSTR subkey, LPTSTR retdata)
{
    HKEY hkey;
...
void CNSHyperEdit::ReportError(int nError)
{
   /* CString str;
    switch (nError) {
...
HINSTANCE CNSHyperEdit::GotoURL(LPCTSTR url, int showcmd)
{
