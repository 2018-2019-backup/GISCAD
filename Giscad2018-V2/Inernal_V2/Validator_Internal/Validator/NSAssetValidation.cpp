...
////}
////
////int CNSAssetValidation::validate(void)
////{
...
////	mapOfAttribs.insert(STRING_MAP::value_type(_T("CAP_NO"), _T("")));
////	mapOfAttribs.insert(STRING_MAP::value_type(_T("DrawingNumber"), _T("")));
////	mapOfAttribs.insert(STRING_MAP::value_type(_T("ProjectNumber"), _T("")));
////	mapOfAttribs.insert(STRING_MAP::value_type(_T("USERSTATUS"), _T("")));
////	mapOfAttribs.insert(STRING_MAP::value_type(_T("DEPOTCODE"), _T("")));
////	mapOfAttribs.insert(STRING_MAP::value_type(_T("EXPORTID"), _T("")));
...
////		m_mapOfEquipNoIDs.insert(std::map<NSSTRING,long>::value_type(szPlantNo,1));
////
////		TCHAR* szOriginalDoc = pData->getValueFromMap(_T("OriginalDoc"));
////		m_mapOfEquipNoAndOriginalDocs.insert(std::map<NSSTRING,NSSTRING>::value_type(szPlantNo,szOriginalDoc));
////
